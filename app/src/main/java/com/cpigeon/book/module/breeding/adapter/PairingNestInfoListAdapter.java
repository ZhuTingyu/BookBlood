...
public class PairingNestInfoListAdapter  extends BaseQuickAdapter<BreedingInfoEntity, BaseViewHolder> {


    public PairingNestInfoListAdapter() {
        super(R.layout.item_pairing_nest_info, Lists.newArrayList(new BreedingInfoEntity.Builder().build(),

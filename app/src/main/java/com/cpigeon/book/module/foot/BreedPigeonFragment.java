...
public class BreedPigeonFragment extends BaseBookFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        bindUi(RxUtils.textChanges(et1), mViewModel.setAddFootNum());
        bindUi(RxUtils.textChanges(et3), mViewModel.setEditFootId());
        bindUi(RxUtils.textChanges(et4), mViewModel.setDelFootId());
        bindUi(RxUtils.textChanges(et6), mViewModel.setDetailsFootId());


        bindUi(RxUtils.textChanges(et8), mViewModel.setSegmentStartFoot());
        bindUi(RxUtils.textChanges(et8_1), mViewModel.setSegmentEndFoot());
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn3:
                ...
                mViewModel.getTXGP_FootRing_EditData();
                break;
            case R.id.btn4:
                //删除足环
            ...
            case R.id.btn5:
                ...
                mViewModel.getTXGP_FootRingSource_SelectData();
                break;
            case R.id.btn6:
                //获取单个足环详细
                Log.d(TAG, "onViewClicked: f");
                mViewModel.getTXGP_FootRing_SelectData();
                break;
            case R.id.btn7:
                //得到各种类型的足环个数
            ...
            case R.id.btn8:
                //添加足环号段
                mViewModel.getTXGP_FootRing_AddSectionData();
                break;

...
public class BreedPigeonViewModel extends BaseViewModel {
    ...
    public void getTXGP_FootRing_EditData() {
        submitRequestThrowError(BreedPigeonModel.getTXGP_FootRing_Edit(footId, foot, money, ringNum, footType, footState, footSource, remark), r -> {
            if (r.isOk()) {
    ...
    public void getTXGP_FootRingSource_SelectData() {
        submitRequestThrowError(BreedPigeonModel.getTXGP_FootRingSource_Select(), r -> {
            if (r.isOk()) {
    ...
    public void getTXGP_FootRing_SelectData() {
        submitRequestThrowError(BreedPigeonModel.getTXGP_FootRing_Select(footDetailsID), r -> {
            if (r.isOk()) {
    ...
    public void getTXGP_FootRing_AddSectionData() {
        submitRequestThrowError(BreedPigeonModel.getTXGP_FootRing_AddSection(segment_startFoot,

...
import com.cpigeon.book.module.menu.adapter.BalanceDetailsAdapter;
...
public class AccountBalanceDetails extends BaseBookFragment {
    ...
    public static void start(Activity activity) {
        IntentBuilder.Builder()
                .startParentActivity(activity, AccountBalanceDetails.class);
    }

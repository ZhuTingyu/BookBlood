package com.base.base.blurdialogfragment;
...
public class BlurDialogEngine {
    ...
    private void blur(Bitmap bkg, View view) {
        ...
        try {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB
                || mHoldingActivity instanceof BaseActivity
    ...
    private int getActionBarHeight() {
        ...
        try {
            ...
            } else if (mHoldingActivity instanceof BaseActivity) {
                ActionBar supportActionBar
                    = ((BaseActivity) mHoldingActivity).getSupportActionBar();

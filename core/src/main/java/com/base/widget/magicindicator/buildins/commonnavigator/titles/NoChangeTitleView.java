...
import com.base.widget.magicindicator.buildins.UIUtil;
...
public class NoChangeTitleView extends TextView implements IMeasurablePagerTitleView {
    protected int mSelectedColor;
    protected int mNormalColor;

    public NoChangeTitleView(Context context) {
        super(context, null);
        init(context);
    }
